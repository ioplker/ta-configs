...
local asterisk_strong_em = flanked_range('***')
local underscore_strong_em = (B(punct_space) + #lexer.starts_line('_')) * flanked_range('___', true) *
  #(punct_space + -1)
lex:add_rule('strong_em', lex:tag('bold_italic', asterisk_strong_em + underscore_strong_em))
