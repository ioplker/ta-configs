...
-- JS++ LPeg lexer (from JavaScript).

local lexer = require('lexer')
local token, word_match = lexer.token, lexer.word_match
local P, S = lpeg.P, lpeg.S

local lex = lexer.new('jspp')
...
lex:add_rule('keyword', token(lexer.KEYWORD, word_match{
  ...
  'auto', 'external', 'foreach', 'label', 'module', 'typeid',
  'override', 'overwrite', 'property', 'virtual',
  'bool', 'signed byte', 'string', 'unsigned int', 'unsigned long', 'unsigned short'
}))
...
textadept.editing.comment_string.jspp = '// '
